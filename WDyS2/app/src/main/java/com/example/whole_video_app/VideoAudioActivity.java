...
public class VideoAudioActivity extends AppCompatActivity {
    ...
    public final String server = "http://172.20.10.14:3535/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anotherone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(VideoAudioActivity.this, MenuActivity.class);
    ...
    public void start_cycle() {
        ...
        new Handler().postDelayed(r_end,4000);
